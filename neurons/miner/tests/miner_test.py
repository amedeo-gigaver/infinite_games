...
async def test_forward_existing_event(miner):
    ...
    event_data = {
        ...
        "market_type": "test_type",
        "description": "Will BTC reach 100k by 2024?",
        "cutoff": future_time.isoformat(),
        "probability": None,
        "miner_answered": False,
    }

    synapse = EventPredictionSynapse(events={"test_event_3": event_data})

    existing_event = MinerEvent.model_validate(event_data)
