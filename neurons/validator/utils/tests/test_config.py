...
class TestConfig:
    ...
    def mock_dependencies(self):
        ...
        with (
            ...
            patch("neurons.validator.utils.config.Subtensor.add_args") as mock_subtensor_add_args,
            patch(
                "neurons.validator.utils.config.LoggingMachine.add_args"
            ) as mock_logging_add_args,
            patch("neurons.validator.utils.config.Wallet.add_args") as mock_wallet_add_args,
            patch("neurons.validator.utils.config.Config", spec=True),
        ):
            # Setup mock parser
