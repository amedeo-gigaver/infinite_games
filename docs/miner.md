...
You will be receiving data in the form defined in `neurons/protocol.py` and will only need to complete the `probability` entry, with `reasoning` entry being optional.
