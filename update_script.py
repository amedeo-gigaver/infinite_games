...
if __name__ == "__main__":
    ...
    parser.add_argument("--check_interval", type=int, required=True, help="Interval to check for any new updates (in seconds)")
    parser.add_argument("--pm2_process_name", required=True, help="Name of the pm2 process to restart")
